...
export default class SuspendDevice extends Component {
    ...
    handleSuspendDevice = (device, refresh) => {
        ...
        const title = (device.account_status === "suspended") ? "Are you sure, you want to activate the device " + device.device_id + " ?" : "Are you sure, you want to suspend the device " + device.device_id + "?";
        this.confirm({
            title: title,
            content: '',
            onOk: (() => {
