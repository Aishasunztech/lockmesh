...
class DeviceActions extends Component {
    ...
    render() {
        return (
            ...
            <Button.Group>
                <Button type="default" icon="check" disabled={!this.state.applyBtn} onClick={() => { this.props.applyActionButton() }} className="action_btn clr_green" />
                <Button type="default" icon="undo" disabled={!this.state.undoBtn} onClick={() => { this.props.undoApplications() }} className="action_btn clr_orange" />
                <Button type="default" icon="redo" disabled={!this.state.redoBtn} onClick={() => { this.props.redoApplications() }} className="action_btn clr_orange" />
                <Button type="default" icon="close" disabled={!this.state.clearBtn} className="action_btn clr_red" />
