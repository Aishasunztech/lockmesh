...
class SideActions extends Component {
    ...
    render() {
        // console.log(this.props.device.flagged);
                    ...
                    <Card>
                        <Row gutter={16} type="flex" justify="center" align="top">
                            <Col span={12} className="gutter-row" justify="center" >
                                ...
                                <Button type="default" style={{ width: "100%", marginBottom: 15, backgroundColor: '#f31517', color: '#fff' }} onClick={() => showConfirm(this.props.device, this.props.wipe, this, "Do you really want to Wipe the device ", 'wipe')}><Icon type="lock" /> Wipe Device</Button>
                            </Col>
                            <Col className="gutter-row" justify="center" span={12} >
                                ...
                                <Button disabled={this.props.device.unlink_status ? true : this.state.disabled} onClick={() => showConfirm(this.props.device, this.props.unlinkDevice, this, "Do you really want to unlink the device ", 'unlink')} style={{ width: "100%", marginBottom: 15, backgroundColor: '#00336C', color: '#fff' }} ><Icon type='disconnect' />Unlink</Button>
