                    ...
                    <Card>
                        <Row gutter={16} type="flex" justify="center" align="top">
                            ...
                            >
                                ...
                                {(localStorage.getItem("type") === "admin") ? <Button type="primary " style={{ width: "100%", marginBottom: 16 }} onClick={() => { this.showSaveProfileModal(true, 'policy') }} ><Icon type="save" style={{ fontSize: "14px" }} /> Save Policy</Button> : null}
                                {(localStorage.getItem("type") === "admin" || localStorage.getItem("type") === "dealer") ? <Button type="primary " style={{ width: "100%", marginBottom: 16 }} onClick={() => { this.showSaveProfileModal(true, 'profile') }} >
