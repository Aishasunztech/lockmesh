export const APK_SHOW_ON_DEVICE = 'show.on.device.id'; // SHOW ON DEVICE
export const APK = 'apk.id'; // APK
export const APK_APP_NAME = 'app.name.id'; // APP NAME
export const APK_APP_LOGO = 'app.logo.id'; // APP LOGO
export const APK_PERMISSION = 'permission.id'; // PERMISSION
