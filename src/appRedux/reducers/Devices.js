...
const initialState = {
    ...
    chat_ids: [],
    pgp_emails: [],
    options: ["DEVICE ID", "FLAGGED", "STATUS", "DEVICE NAME", "ACCOUNT EMAIL", "ACTIVATION CODE", "PGP EMAIL", "CHAT ID", "CLIENT ID", "DEALER ID", "DEALER PIN", "MAC ADDRESS", "SIM ID", "IMEI 1", "SIM 1", "IMEI 2", "SIM 2", "SERIAL NUMBER", "MODEL", "START DATE", "EXPIRY DATE", "DEALER NAME", "ONLINE", "S-DEALER", "S-DEALER NAME"],
    newDevices: [],
};
