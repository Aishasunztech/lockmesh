...
@Component({
  selector: 'app-sdealer-devices',
  templateUrl: './sdealer-devices.component.html',
  styleUrls: ['./sdealer-devices.component.css']
})
export class SdealerDevicesComponent implements OnInit {
...
async alldealerDeviceView() {
  ...
  console.log(id);
//  this.spinnerService.show();
  await this.restService.getUserSubDealerDevice(id).subscribe((response) => {
  console.log( response);
 // this.spinnerService.hide();
