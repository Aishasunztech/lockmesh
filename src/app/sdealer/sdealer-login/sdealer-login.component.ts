...
@Component({
  selector: 'app-sdealer-login',
  templateUrl: './sdealer-login.component.html',
  styleUrls: ['./sdealer-login.component.css']
})
export class SdealerLoginComponent implements OnInit {
  ...
  dealerLogin() {
   ...
   //   console.log(resp);
      if (this.resp.status === true) {
        ...
        this.storage.set('type', 'sdealer');
        this.router.navigate(['sdealer/devices']);
      } else  {
        Swal ({
          text: this.resp.msg,
          type: 'warning',
