...
@Component({
  selector: 'app-s-connect-devices',
  templateUrl: './s-connect-devices.component.html',
  styleUrls: ['./s-connect-devices.component.css']
})
export class SConnectDevicesComponent implements OnInit {
  device_data = {
    account_status: '',
  client_id: '',
  device_id: '',
